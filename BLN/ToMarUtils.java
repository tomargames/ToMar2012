...
//		return sysDate.toString();
	...
	public static ImageIcon getImage(Applet a, String url, int width, int height) throws Exception
	{
   		ImageIcon img = null;
   		try 
   		{
   			img = new ImageIcon((a.getImage(new URL(url))).getScaledInstance(width, height, 1));
        } 
   		catch (Exception e)
   		{
   			throw new Exception("Error from ToMarUtils.getImage() at " + getDateTimeStamp() + ": " + e);	
   		}
   		return img;
	}
