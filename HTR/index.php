...
if ($id == null)
{
	echo "<script> window.location = '".$site."HTR/login.php?login'; </script>";
}	
...
<table border=0 align="center"><tr>	
	<td width="10%"><img src="HTR.jpg" height="100" width="100"></td>
	<td  width="80%" class="biggest">HappyTrails<br><span class="magenta10">by ToMarGames</span><br></td>
	<td width="10%"><img src="HTR.jpg" height="100" width="100"></td></tr>
</table>
<table border="0" align="center"><tr>
...
<?php 
	$w = 820;
	$h = 600;
	echo "<applet name='applet' code='HTR.class' width='".$w."' height='".$h."'>";
...
<br>HappyTrails is especially for Miranda!<br>
<br>About the Game
	<ul class=green10>
		<li>Use the arrow keys to set your blue guy in motion.</li>
		<li>Once your guy is in motion, he never stops, so you have to guide him to avoid obstacles.</li>
		<li>As you eat up the green guys, they turn into your tail and they follow you around.</li>
		<li>If you run into your tail, or a red guy, or a wall, you die.</li>
		<li>The longer your tail is, the more points you get for eating the green guys.</li>
		<li>Hitting a purple guy will make you lose your tail.</li>
